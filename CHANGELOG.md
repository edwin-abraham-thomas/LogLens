...
- Updated npm dependencies to fix 6 high-severity vulnerabilities (tar, glob, @isaacs/brace-expansion)
- Updated Vite and @vitejs/plugin-react to latest versions
- Updated @types/node to compatible version
- Optimized backend to include only production dependencies in Docker image
- Reduced image size from 81 MB to 70 MB
